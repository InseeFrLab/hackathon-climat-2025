...
subtitle: "Explore temperature and precipitation forecasts for 2093, 2095, and 2099"
format:
  html:
    code-tools: false
---
...
// API configuration
apiBaseUrl = "https://user-meilametayebjee-424595-0.user.lab.sspcloud.fr/proxy/5003/"
...
selectedData = {
  ...
  return {
    ...
    data: {
      ...
      "2093": apiResponse.climate["2093"],
      "2095": apiResponse.climate["2095"],
      "2099": apiResponse.climate["2096"]
    }
  };
}
```
  ...
  selectedData && selectedData !== "not_found" ? `
    <div class="cards">
      <div class="card" style="background: linear-gradient(135deg, #3B82F6 0%, #2563EB 100%);">
        <h3>2093</h3>
        <p><strong>Min:</strong> ${selectedData.data["2093"].temp_min}°C</p>
        <p><strong>Max:</strong> ${selectedData.data["2093"].temp_max}°C</p>
        <p><strong>Precipitation:</strong> ${selectedData.data["2093"].annual_precip}mm</p>
        <p><strong>Wind:</strong> ${selectedData.data["2093"].wind}mm</p>
      </div>
      <div class="card" style="background: linear-gradient(135deg, #F59E0B 0%, #D97706 100%);">
        <h3>2095</h3>
        <p><strong>Min:</strong> ${selectedData.data["2095"].temp_min}°C</p>
        <p><strong>Max:</strong> ${selectedData.data["2095"].temp_max}°C</p>
        <p><strong>Precipitation:</strong> ${selectedData.data["2095"].annual_precip}mm</p>
        <p><strong>Wind:</strong> ${selectedData.data["2095"].wind}mm</p>
      </div>
      <div class="card" style="background: linear-gradient(135deg, #EF4444 0%, #DC2626 100%);">
        <h3>2099</h3>
        <p><strong>Min:</strong> ${selectedData.data["2099"].temp_min}°C</p>
        <p><strong>Max:</strong> ${selectedData.data["2099"].temp_max}°C</p>
        <p><strong>Precipitation:</strong> ${selectedData.data["2099"].annual_precip}mm</p>
        <p><strong>Wind:</strong> ${selectedData.data["2099"].wind}mm</p>
      </div>
    </div>
  ` : ''
}`
...
Inputs.table(
  selectedData && selectedData !== "not_found"
    ? [
        { metric: "Annual Minimum (°C)", "2093": selectedData.data["2093"].temp_min, "2095": selectedData.data["2095"].temp_min, "2099": selectedData.data["2099"].temp_min },
        { metric: "Annual Maximum (°C)", "2093": selectedData.data["2093"].temp_max, "2095": selectedData.data["2095"].temp_max, "2099": selectedData.data["2099"].temp_max }
      ]
    : [],
  {
    format: {
...
Inputs.table(
  selectedData && selectedData !== "not_found"
    ? [
        { metric: "Annual Precipitation (mm)", "2093": selectedData.data["2093"].annual_precip, "2095": selectedData.data["2095"].annual_precip, "2099": selectedData.data["2099"].annual_precip }
      ]
    : []
)
```
...
Inputs.table(
  selectedData && selectedData !== "not_found"
    ? [
        { metric: "Wind Force (km/h)", "2093": selectedData.data["2093"].wind, "2095": selectedData.data["2095"].wind, "2099": selectedData.data["2099"].wind }
      ]
    : []
)
```
...
The projections show trends of increasing temperatures and changing precipitation patterns from 2093 through 2099.
